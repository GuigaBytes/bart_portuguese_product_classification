...
stationery = [
    ["CANETA ESFEROGRÁFICA AZUL BIC", "papelaria"],
    ["BLOCO DE NOTAS ADESIVAS POST-IT", "papelaria"],
    ["LÁPIS PRETO Nº2 FABER-CASTELL", "papelaria"],
    ["BORRACHA BRANCA MERCUR", "papelaria"],
    ["MARCA TEXTO AMARELO STABILO", "papelaria"],
    ["PASTA POLIONDA A4", "papelaria"],
    ["GRAMPEADOR DE MESA 26/6", "papelaria"],
    ["CLIPS PARA PAPEL Nº 2/0", "papelaria"],
    ["RÉGUA DE 30CM ACRÍLICO", "papelaria"],
    ["CORRETIVO LÍQUIDO 18ML", "papelaria"],
    ["CADERNO UNIVERSITÁRIO 200 FOLHAS", "papelaria"],
    ["ETIQUETAS ADESIVAS PIMACO", "papelaria"],
    ["ENVELOPE SACO KRAFT 260X360MM", "papelaria"],
    ["FITA ADESIVA TRANSPARENTE 45X40", "papelaria"],
    ["PERFURADOR DE PAPEL 2 FUROS", "papelaria"],
    ["COLA BASTÃO 21G", "papelaria"],
    ["DIVISÓRIAS PARA FICHÁRIO A4", "papelaria"],
    ["PAPEL SULFITE A4 500 FOLHAS", "papelaria"],
    ["TESOURA ESCOLAR 13CM", "papelaria"],
    ["ESTOJO ESCOLAR SIMPLES", "papelaria"],
    ["PASTA COM ELÁSTICO A4", "papelaria"],
...
gardening = [
    ["TERRA VEGETAL 5KG", "jardinagem"],
    ["VASO DE CERÂMICA 20CM", "jardinagem"],
    ["SEMENTES DE TOMATE CEREJA", "jardinagem"],
    ["REGADOR PLÁSTICO 5L", "jardinagem"],
    ["ADUBO ORGÂNICO 2KG", "jardinagem"],
    ["LUVA PARA JARDINAGEM", "jardinagem"],
    ["KIT FERRAMENTAS PARA JARDIM 4 PEÇAS", "jardinagem"],
    ["MANGUEIRA FLEXÍVEL 15M", "jardinagem"],
    ["PRAGUICIDA ORGÂNICO 500ML", "jardinagem"],
    ["SERRA PODA MANUAL", "jardinagem"],
    ["SUBSTRATO PARA ORQUÍDEAS 2KG", "jardinagem"],
    ["PEDRAS DECORATIVAS BRANCAS", "jardinagem"],
    ["PÁ PARA JARDIM", "jardinagem"],
    ["CORTADOR DE GRAMA ELÉTRICO", "jardinagem"],
    ["ESPETO PARA JARDIM SOLAR LED", "jardinagem"],
    ["PLANTA SUCCULENTA EM VASO", "jardinagem"],
    ["PULVERIZADOR MANUAL 2L", "jardinagem"],
    ["FERTILIZANTE PARA FLORES 1KG", "jardinagem"],
    ["TESOURA PARA PODA", "jardinagem"],
    ["SUPORTE PARA VASOS DE PAREDE", "jardinagem"],
    ["KIT SEMENTES DE ERVAS AROMÁTICAS", "jardinagem"],
    ["INSETICIDA NATURAL 500ML", "jardinagem"],
    ["TESOURA DE PODA ALTA PERFORMANCE", "jardinagem"],
...
seasonal = [
    ["DECORAÇÃO DE NATAL - PISCA-PISCA LED", "sazonal"],
    ["ÁRVORE DE NATAL ARTIFICIAL 1,5M", "sazonal"],
    ["FANTASIA DE BRUXA INFANTIL - HALLOWEEN", "sazonal"],
    ["OVOS DE PÁSCOA DE CHOCOLATE 250G", "sazonal"],
    ["GUIRLANDA NATALINA 40CM", "sazonal"],
    ["MÁSCARA DE CARNAVAL VENEZIANA", "sazonal"],
    ["VELAS DECORATIVAS - DIA DOS NAMORADOS", "sazonal"],
    ["CARTÕES DE NATAL - KIT COM 10", "sazonal"],
    ["ENFEITES PARA ÁRVORE DE NATAL - KIT COM 20", "sazonal"],
    ["LANTERNA DECORATIVA PARA FESTA JUNINA", "sazonal"],
    ["COELHO DE PELÚCIA - PÁSCOA", "sazonal"],
    ["BALÕES TEMÁTICOS - ANIVERSÁRIO", "sazonal"],
    ["PRESENTE DIA DAS MÃES - VASO DECORATIVO", "sazonal"],
    ["ARTIGOS PARA DECORAÇÃO DE HALLOWEEN", "sazonal"],
    ["COLHER DE MADEIRA PARA FESTA JUNINA", "sazonal"],
    ["CHAPÉU DE PAPAI NOEL", "sazonal"],
    ["CARTÃO DIA DOS PAIS", "sazonal"],
    ["KIT DE TALHERES PARA CEIA DE NATAL", "sazonal"],
    ["FANTASIA DE COELHINHO - PÁSCOA", "sazonal"],
    ["BANDEIRINHAS COLORIDAS - FESTA JUNINA", "sazonal"],
    ["CAIXA DE BOMBONS - DIA DOS NAMORADOS", "sazonal"],
    ["DECORAÇÃO PARA FESTA JUNINA - BALÃO", "sazonal"],
    ["FANTASIA DE SUPER-HERÓI INFANTIL - CARNAVAL", "sazonal"],
    ["KIT DE ENFEITES PARA PÁSCOA", "sazonal"],
    ["VELAS AROMÁTICAS - DIA DAS MÃES", "sazonal"],
    ["PISCA-PISCA COLORIDO - NATAL", "sazonal"],
    ["MÁSCARA DE CARNAVAL - ADULTO", "sazonal"],
    ["FANTASIA DE PAPAI NOEL", "sazonal"],
...
pet_shop = [
    ["RAÇÃO SECA PARA CÃES ADULTOS", "pet-shop"],
    ["AREIA SANITÁRIA PARA GATOS", "pet-shop"],
    ["ANTIPULGAS PARA CACHORRO", "pet-shop"],
    ["COMEDOURO PARA GATOS", "pet-shop"],
    ["BISCOITO CANINO", "pet-shop"],
    ["COLAR ELIZABETANO", "pet-shop"],
    ["RAÇÃO ÚMIDA PARA GATOS", "pet-shop"],
    ["BRINQUEDO PARA GATOS", "pet-shop"],
    ["CAMA PARA CÃES", "pet-shop"],
    ["SHAMPOO PARA CÃES", "pet-shop"],
    ["PETISCOS PARA GATOS", "pet-shop"],
    ["CAPA DE CHUVA PARA CÃES", "pet-shop"],
    ["ESCOVA PARA PELAGEM DE ANIMAIS", "pet-shop"],
    ["GUARDA-ROUPA PARA CACHORRO", "pet-shop"],
    ["VITAMINAS PARA PÁSSAROS", "pet-shop"],
    ["CASA PARA HAMSTER", "pet-shop"],
    ["PEIXEIRA", "pet-shop"],
    ["RAÇÃO PARA PEIXES", "pet-shop"],
    ["ARRANHADOR PARA GATOS", "pet-shop"],
    ["BEBEDOURO AUTOMÁTICO PARA ANIMAIS", "pet-shop"],
    ["GUARDA-CHUVA PARA CÃES", "pet-shop"],
    ["RAÇÃO DIETÉTICA PARA GATOS", "pet-shop"],
    ["CINTO DE SEGURANÇA PARA PET", "pet-shop"],
    ["FILTRO PARA AQUÁRIO", "pet-shop"],
    ["RAÇÃO PARA CACHORROS SENIORES", "pet-shop"],
    ["KIT DE HIGIENE PARA GATOS", "pet-shop"],
    ["TAPETE HIGIÊNICO PARA CÃES", "pet-shop"],
    ["COLEIRA COM GPS", "pet-shop"],
    ["LIMPADOR DE OUVIDOS PARA ANIMAIS", "pet-shop"],
...
toys = [
    ["BONECA FALANTE", "brinquedos"],
    ["CARRO CONTROLE REMOTO", "brinquedos"],
    ["QUEBRA-CABEÇA 1000 PEÇAS", "brinquedos"],
    ["JOGO DE TABULEIRO", "brinquedos"],
    ["LEGO KIT DE MONTAGEM", "brinquedos"],
    ["BONECO DE AÇÃO", "brinquedos"],
    ["BOLA DE FUTEBOL", "brinquedos"],
    ["CASA DE BONECAS", "brinquedos"],
    ["BICICLETA INFANTIL", "brinquedos"],
    ["PISTA DE CARRINHOS", "brinquedos"],
    ["IOIÔ", "brinquedos"],
    ["BONECA DE PANO", "brinquedos"],
    ["JOGO DE MEMÓRIA", "brinquedos"],
    ["ANIMAIS DE PLÁSTICO", "brinquedos"],
    ["TRAMPOLIM", "brinquedos"],
    ["MASSINHA DE MODELAR", "brinquedos"],
    ["TAPETE DE ATIVIDADES PARA BEBÊS", "brinquedos"],
    ["CUBO MÁGICO", "brinquedos"],
    ["KIT DE CIÊNCIAS", "brinquedos"],
    ["LANÇADOR DE DARDOS", "brinquedos"],
    ["PIANO INFANTIL", "brinquedos"],
    ["KIT DE MÁGICA", "brinquedos"],
    ["CAMINHÃO DE BRINQUEDO", "brinquedos"],
    ["DRONE INFANTIL", "brinquedos"],
    ["CONJUNTO DE CHÁ", "brinquedos"],
    ["TRENZINHO", "brinquedos"],
    ["BONECO ROBÔ", "brinquedos"],
...
health = [
    ["ANALGÉSICO PARACETAMOL", "saúde"],
    ["CURATIVOS ADESIVOS", "saúde"],
    ["TERMÔMETRO DIGITAL", "saúde"],
    ["VITAMINA C", "saúde"],
    ["XAROPE PARA TOSSE", "saúde"],
    ["ANTISSÉPTICO BUCAL", "saúde"],
    ["PROTETOR SOLAR FPS 50", "saúde"],
    ["PRESERVATIVOS", "saúde"],
    ["ÓCULOS DE LEITURA", "saúde"],
    ["BANDAGEM ELÁSTICA", "saúde"],
    ["POMADA PARA DOR MUSCULAR", "saúde"],
    ["ALCOOL EM GEL", "saúde"],
    ["TESTE DE GRAVIDEZ", "saúde"],
    ["REPELENTE CONTRA INSETOS", "saúde"],
    ["LENÇOS UMEDECIDOS ANTIBACTERIANOS", "saúde"],
    ["PASTILHAS PARA GARGANTA", "saúde"],
    ["SABONETE ANTIBACTERIANO", "saúde"],
    ["MEDICAMENTO ANTIÁCIDO", "saúde"],
    ["CÁPSULAS DE ÔMEGA 3", "saúde"],
